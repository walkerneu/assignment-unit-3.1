...
let favoriteFoods = ['black olives', 'bibimbap', 'pizza', 'dried mangos'];
...
let finalAnimal = animalArray[animalArray.length - 1];
console.log('Final animal is', finalAnimal);
...
console.log('Added my favorite dessert to end', favoriteFoods);
...
let entree = 'Thai Drunken Noodles';
...
gems.sort();
gems.reverse();
console.log('The gems are in reverse alphabetical:', gems);
